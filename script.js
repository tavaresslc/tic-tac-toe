...
// Função para jogar
function play(y) {
    // Lógica para realizar um movimento
...
// Outras funções auxiliares para verificação de vitória, recomeçar o jogo, etc.
...
// Estilização da interface de jogo em HTML
function gameOver(a) {
    var gameOverAlertElement = "<b>GAME OVER </b><br><br>" + span[a].dataset.player.toUpperCase() + ' Venceu !!! <br><br>' + restartButton;
